...
<body>
	...
	<section id="top">
		...
		<div class="container intro-text">
			<h2 class="text-center">Aveți dificultăți în găsirea de asistenți medicali calificați, moașe sau medici? Sunteți în căutarea unui partener de afaceri de încredere care să vă ajute să îi găsiți? Nu vă faceți griji, tocmai ați găsit unul.</h2>
		</div>
	</section>
	<section id="one">
	...
	<div class="green three" style="background: #222;">
		...
		<div class="btn-group btn-group-justified" role="group">
		  ...
		  <div class="btn-group" role="group">
			<button type="button" class="btn btn-default country three">Lucrătorii temporari</button>
		  </div>
		</div>
