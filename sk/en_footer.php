    ...
    for (i=0; i<(args.length-2); i+=3) { test=args[i+2]; val=document.getElementById(args[i]);
      if (val) { nm=val.name; if ((val=val.value)!="") {
        if (test.indexOf('isEmail')!=-1) { p=val.indexOf('@');
          if (p<1 || p==(val.length-1)) errors+='- '+' zadajte platný e-mail.\n';
...
<?php
	...
	$end = end(explode('/', $url));
?>
		<a href="../en/<?php echo $end ?>">ENGLISH</a> | <a href="#">SLOVENSKY</a> | <a href="../cz/<?php echo $end?>">ČESKY</a> | <a href="../ro/<?php echo $end?>">ROMÂNĂ</a>
</div>
<br>
<div class="container">
		<div class="row">
