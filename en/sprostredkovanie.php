...
<body>
	...
	<section id="top">
		...
		<div class="container intro-text">
			<h2 class="text-center">Chceli by sme Vám v skratke predstaviť našu spoločnosť ktorá posobí v niekolkych europských krajinach. </h2>
		</div>
	</section>
	<section id="one">
			...
			<div class="container">
				...
				<div class="container">
					...
					<div class="article-finish"></div>
						...
						<img src="img/CloseupofApplicantCompletingApplicationForm.jpg" alt="img" class="decoration">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-6 litem">
						...
						<p class="nmbrlist">Make the first step and complete our CONTACT FORM or upload your CV and we will contact you.</p>
					</div>
					<div class="col-lg-6 litem">
		...
		<p>When you want to provide jobs or services as a caregiver, there is certain criteria that have to be met. For more information please select:</p>
			<div class="row country-sel">
				<div class="col-lg-6">
					...
					</select> <span aria-hidden="true" class="glyphicon glyphicon-triangle-bottom selectarrow" style="margin-top: 70px;"></span>
				</div>
				<div class="col-lg-6">
