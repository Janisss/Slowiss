...
<body>
	...
	<section id="top">
		...
		<div class="container-fluid first-content">
			<ul data-limit-x="40" data-limit-y="20" id="scene">
				<li class="layer" data-depth="0.00"><img alt="CARE" class="decoimg" src="scene1.2/1.jpg"></li>
				<li class="layer" data-depth="0.25"><img alt="CARE" class="decoimg" src="scene1.2/2.png"></li>
				<li class="layer" data-depth="0.25"><img alt="CARE" class="decoimg" src="scene1.2/3.png"></li>
			</ul>
		</div>
				...
				<div class="container">
					...
					<div class="row icons">
						...
						<div class="col-md-4">
							...
							<h3 class="text-center">Innovative recruitment process</h3>
						</div>
					</div>
					...
					<div class="article-finish"></div>
					<p style="text-align: center">Quality and reliability of our services is ranking us among the top personnel mediation companies on the European market. We have available for you medical personnel from whole Europe thanks to free movement of services in the European union. Join our satisfied clients and business partners to appreciate the simplicity of whole process, minimum effort and legal security that you get from us.</p>
	...
	<img src="img/AdobeStock_80193045.jpeg" alt="IMG" style="width: 100%;">
	<div class="green two">
		<section id="two">
			<div class="container">
			<h1>Services</h1>
			<div class="container">
			<p style="text-align: center">Slowiss has headquarters within whole Middle and Eastern Europe. We provide you complex services in the area of mediation of jobs or services and provision of medical personnel. Within the recruitment process we put emphasis on: </p>
			
			<div class="row">
					<div class="col-lg-6 litem">
					<img src="../main_img/AdobeStock_99592932.jpeg" alt="IMG" style="width: 100%;">
					</div>
					<div class="col-lg-6 litem">
	...
	<img src="img/AdobeStock_129322030.jpeg" alt="IMG" style="width: 100%;">
	</div>
