...
foreach($offers as $data){
	...
	$smoke = $data["SMOKE"];
	$drive = $data["DRIVE"];
	echo "<div class='row offer'><div class='col-xs-3 location' style='background-image: url(../kanton/".$img.".jpg)'><span class='loc-span'>Ponuka číslo ".$nr."</span></div><div class='col-xs-2' style='border-right:1px solid #eee'><span>Pozícia</span><p>".$position."</p><span>Krajina</span><p>".$country."</p><hr><img src='../icons/driving.png' alt='Vodičský preukaz' class='offer-icon' style='display:".$drive.";'><img src='../icons/nosmoking.png' alt='Nefajčiar' class='offer-icon' style='display:".$smoke.";'><br><br><a href='#' class='viac' onclick='return false'>Viac info</a><br><a href='#mamzaujem' class='zaujem' onclick='return false'>Mám záujem</a></div><div class='col-xs-5 text' style='border-right:1px solid #eee'>".$desc."</div><div class='col-xs-2'><span>Nástup</span><p>".$date."</p><span>Plat</span><p>".$salary."</p><span>Turnus</span><p>".$turnus."</p></div></div>";
}	
?>
