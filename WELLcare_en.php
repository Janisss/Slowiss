...
<body>
	...
	<section id="one">
		<div class="green one" style="background: rgb(107, 40, 92);">
			<div class="container">
				<h1>Why us?</h1>
				<p>Join our team of keen care assistants and find out about quality of our services and friendly approach that rank us between TOP personal consulting companies on the European market in the realm of mediating of jobs or services.</p><br>
				<div class="container">
					<h2 class="text-center">Benefits of working with us</h2><br>
					<!-- flaticons -->
					<div class="row icons">
						<div class="col-md-4">
	...
	<section id="four">
		...
		<div class="container">
			<div class="row country-sel">
				<div class="col-lg-6">
					<h3>Where are you from:</h3><select class="myselect" id="from" name="from">
				...
				<div class="col-lg-6">
					<h3>Where do you want to go:</h3><select class="myselect" id="to" name="to">
						<option disabled selected value="zero">
							Please select...
						</option>
						<option value="DE">
